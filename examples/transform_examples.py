...
def example_1_simple_workflow():
    ...
    with mlflow.start_run():
        ...
        loaded_transform = load_transform_function_by_name("add_sales_tax")
...
def example_4_full_ml_pipeline():
    ...
    with mlflow.start_run():
        # Log all transforms
        log_transform_function(clean_and_validate_data, "data_cleaning")
        log_transform_function(ml_preprocessing_pipeline, "ml_preprocessing")
        ...
        cleaning_transform = load_transform_function_by_name("data_cleaning")
        ml_transform = load_transform_function_by_name("ml_preprocessing")
...
def example_5_version_management():
    ...
    with mlflow.start_run():
        ...
        # Find all versions
        versions = find_transform_versions(name="calculate_discount")
        ...
        v1_transform = load_transform_function_by_name(
            "calculate_discount",
            version_constraint=">=1.0.0,<2.0.0",
        )
        v2_transform = load_transform_function_by_name(
            "calculate_discount",
