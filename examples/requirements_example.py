...
def example_3_function_clustering():
    ...
    with mlflow.start_run():
        # Log a cluster of related functions
        print("Logging data processing cluster...")
        log_transform_cluster(
            functions=[data_cleaner, feature_engineer, scoring_function],
            cluster_name="data_processing_pipeline",
            input_example=df,
            validate_dependencies=True,
        )
        ...
        cluster_transform = load_transform_function_by_name("data_processing_pipeline")
